...
#define DESC_SUB_VERSION                                             0x06
#define DESC_BUGFIX_VERSION                                          0x10
...
#define DESC_IMPLEMENTATION_MAGIC_NUMBER                             24158
...
# error "ApplDesc.h doesn't match the Desc.c generation time!"
#endif
...
#define kDescUsdtNetPrimInfoPool                                     (vuintx)0
#define kDescUsdtNetSecInfoPool                                      (vuintx)(kDescNumContexts - 1)

#if defined (DESC_USDTNET_ENABLE_MULTI_TP)
# define TP_CHANNEL_PARAM_TYPE_ONLY                                  vuint8
# define TP_CHANNEL_PARAM_TYPE_FIRST                                 vuint8,
# define TP_CHANNEL_RX_PARAM_VALUE                                   tpRxChannel
# define TP_CHANNEL_RX_PARAM_ONLY                                    tpRxChannel
# define TP_CHANNEL_RX_PARAM_FIRST                                   tpRxChannel,
# define TP_CHANNEL_RX_FORMAL_PARAM_DEF_ONLY                         TP_CHANNEL_PARAM_TYPE_ONLY TP_CHANNEL_RX_PARAM_ONLY
# define TP_CHANNEL_RX_PARAM_DEF_LOCAL                               TP_CHANNEL_RX_FORMAL_PARAM_DEF_ONLY;
# define TP_CHANNEL_RX_FORMAL_PARAM_DEF_FIRST                        TP_CHANNEL_PARAM_TYPE_ONLY TP_CHANNEL_RX_PARAM_ONLY,
# define TP_CHANNEL_RX_PARAM_IGNORE_UNREF                            DESC_IGNORE_UNREF_PARAM(tpRxChannel)

# if defined (TP_ENABLE_DYNAMIC_CHANNELS)
#  define TP_CHANNEL_TX_PARAM_VALUE                                  tpTxChannel
#  define TP_CHANNEL_TX_PARAM_ONLY                                   tpTxChannel
#  define TP_CHANNEL_TX_PARAM_FIRST                                  tpTxChannel,
#  define TP_CHANNEL_TX_FORMAL_PARAM_DEF_ONLY                        TP_CHANNEL_PARAM_TYPE_ONLY TP_CHANNEL_TX_PARAM_ONLY
#  define TP_CHANNEL_TX_PARAM_DEF_LOCAL                              TP_CHANNEL_TX_FORMAL_PARAM_DEF_ONLY;
#  define TP_CHANNEL_TX_FORMAL_PARAM_DEF_FIRST                       TP_CHANNEL_PARAM_TYPE_ONLY TP_CHANNEL_TX_PARAM_ONLY,
# else
#  if defined(DESC_ENABLE_MULTI_TP_MULTI_CAN_WORKAROUND)
#   define TP_CHANNEL_TX_PARAM_VALUE                                 g_descCan2TpChannelMap[DESC_COMM_CHANNEL_PARAM_WRAP_INDEX(g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].busInfo.addressingInfo.isoTp.CanChannel)]
#  else
...
#  define TP_CHANNEL_TX_FORMAL_PARAM_DEF_ONLY                        TP_CHANNEL_PARAM_TYPE_ONLY tpTxChannel
#  define TP_CHANNEL_TX_PARAM_DEF_LOCAL                              TP_CHANNEL_TX_FORMAL_PARAM_DEF_ONLY;
#  define TP_CHANNEL_TX_FORMAL_PARAM_DEF_FIRST                       TP_CHANNEL_PARAM_TYPE_ONLY tpTxChannel,
# endif
# define TP_CHANNEL_TX_PARAM_IGNORE_UNREF                            DESC_IGNORE_UNREF_PARAM(tpTxChannel)
#else
# define TP_CHANNEL_PARAM_TYPE_ONLY                                  void
# define TP_CHANNEL_PARAM_TYPE_FIRST
...
#define kDescStateGroupNumTransition                                  7
...
/* SvcHead table size. */
#define kDescSvcHeadNumItems                                         22
/* SvcInst table size. */
#define kDescSvcInstNumItems                                         51
/* SvcInstHeadEx table size. */
#define kDescSvcInstHeadExtNumItems                                  78
/* Context modes */
...
# error "kDescMaxNumberOfAttempts out of range, please set retries for retries [1..255]!"
    ...
    defined (DESC_ENABLE_USE_OLD_SEED_PROTECTION) && \
    !defined (DESC_ENABLE_LEVEL_SPECIFIC_SEED_PROTECTION)
# error "Illegal configuration. The seed must have constant lenght for any level!"
#endif

#define kDescNumPids                                                 122
...
typedef struct
{
  ...
  vbittype            contextMode                :3;/* 0x00 - Normal, 0x01 - PIDListProcess */
  vbittype            isApplError                :1;/* 0x00 - CANdesc NR, 0x01 - APPL NR */
  vbittype            dummy                      :4;
} DescContextCtrl;
...
typedef struct
{
  ...
  vbittype           forcedRcrRpState       :2;/* 0x00 - Idle, 0x01 - Charged, 0x02 - WaitConfirmation */
#endif
  vbittype           isContextLocked        :1;
...
typedef struct
{
  vbittype                reqHeadByteSpec   :8; /* Each bit represents sub-function/identifier - 0: identifier; 1: any subfunction */
#if defined(DESC_ENABLE_SUB_SVC_USAGE)
  vbittype                reqHeadExLen      :4; /* Request HeadEx length up to 7 Byte  */
  vbittype                resHeadExLen      :4; /* Response HeadEx length up to 7 Byte */
#endif
  vbittype                reqType           :2; /* 0x01: Phys 0x02: Func */
  vbittype                resOnReq          :2; /* 0x01: Phys 0x02: Func */
  vbittype                suppPosRes        :1; /* 0x00: No   0x01: Yes  */
  vbittype                isReqHeadExtEchoed:1; /* 0x00: No   0x01: Yes  */
  vbittype                isSubFuncInstanced:1; /* 0x00: No   0x01: Yes  */
#if (kDescNumSvcHeadConstGapBits > 0)
  vbittype                svcHeadPlaceHolder:kDescNumSvcHeadConstGapBits; /* Gap holder  */
#endif
  ...
  vbittype                sessionPlaceHolder:kDescNumSvcHeadSessionGapBits; /* Gap holder  */
#endif
...
static DescBool DescSendSpontaneousResponse(DescMsg resData, DescMsgLen resLen, t_descUsdtNetBus busInfo);
#endif
...
static void DESC_API_CALLBACK_TYPE DescOemStartDefault_Session(DescMsgContext* pMsgContext);
static void DESC_API_CALLBACK_TYPE DescOemStartProgramming_Session(DescMsgContext* pMsgContext);
static void DESC_API_CALLBACK_TYPE DescOemStartExtended_Session(DescMsgContext* pMsgContext);
static void DESC_API_CALLBACK_TYPE DescReadDataByIdentifier(DescMsgContext* pMsgContext);
static void DESC_API_CALLBACK_TYPE DescOemRequestRequest_Seed_Level_1(DescMsgContext* pMsgContext);
static void DESC_API_CALLBACK_TYPE DescOemSendSend_Key_Level_1(DescMsgContext* pMsgContext);
static void DESC_API_CALLBACK_TYPE DescOemRequestRequest_Seed_Level_2(DescMsgContext* pMsgContext);
static void DESC_API_CALLBACK_TYPE DescOemSendSend_Key_Level_2(DescMsgContext* pMsgContext);
...
#endif
static void             DescPmAnalysePid         (DESC_CONTEXT_FORMAL_PARAM_DEF_FIRST V_MEMROM1 DescPidTinyInfo V_MEMROM2 V_MEMROM3 * pRefTinyInfo);
#if defined(DESC_ENABLE_DYN_DEFINED_DID_MODE) || \
    defined(DESC_ENABLE_PID_LIST_MODE)        || \
    defined(DESC_ENABLE_DYN_DEFINED_DPID_MODE)
...
#if defined (DESC_USDTNET_ENABLE_MULTI_TP)
# if defined (TP_ENABLE_DYNAMIC_CHANNELS)
static vuint8 g_descUsdtNetTpTxChannel;
# endif
#endif
...
static DESC_USDTNET_BUF_MEMORY_MODEL vuint8 g_descBuffer[kDescPrimBufferLen];
...
static DescAddChannelCtrl g_descAddChannelCtrl;
#endif
...
static DescMsgItem             g_descRcrrpBuffer[kDescNumContexts][3];
...
static vuint8                     g_descSecurityAccessSeedBuffer[kDescSecurityAccessSeedLength];
#endif
...
{
  { { 0x06, 0x06, 0x00 }, { 0x01, 0x01, 0x00 } }, 
  { { 0x06, 0x06, 0x00 }, { 0x01, 0x02, 0x00 } }, 
  { { 0x02, 0x05, 0x00 }, { 0x01, 0x04, 0x00 } }, 
  { { 0x07, 0x06, 0x00 }, { 0x01, 0x01, 0x00 } }, 
  { { 0x07, 0x06, 0x00 }, { 0x01, 0x01, 0x00 } }, 
...
{
  0xFF, 0x00, 0x01, 0x02, 0x03, 0xFF, 0xFF, 0x04, 0xFF, 0x05, 0x06, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 
  0x07, 0x08, 0xFF, 0xFF, 0x09, 0xFF, 0xFF, 0xFF, 0xFF, 0x0A, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 
  0xFF, 0xFF, 0x0B, 0xFF, 0xFF, 0xFF, 0xFF, 0x0C, 0x0D, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x0E, 0xFF, 
  0xFF, 0x0F, 0xFF, 0xFF, 0x10, 0xFF, 0x11, 0x12, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x13, 0xFF, 
...
{
  { 0x01, 0, 0, 0x03, 0x03, 0, 1, 0, 0x00, 0x07, 0x00,  1,  0,  0 } /* $1 */, 
  { 0x01, 0, 0, 0x03, 0x03, 0, 1, 0, 0x00, 0x07, 0x00,  1,  1,  0 } /* $2 */, 
  { 0x01, 0, 0, 0x03, 0x03, 0, 1, 0, 0x00, 0x07, 0x00,  1,  2,  0 } /* $3 */, 
  { 0x01, 0, 0, 0x03, 0x03, 0, 1, 0, 0x00, 0x07, 0x00,  1,  3,  0 } /* $4 */, 
  { 0x01, 0, 0, 0x03, 0x03, 0, 1, 0, 0x00, 0x07, 0x00,  1,  4,  0 } /* $7 */, 
  { 0x01, 0, 0, 0x03, 0x03, 0, 1, 0, 0x00, 0x07, 0x00,  1,  5,  0 } /* $9 */, 
  { 0x01, 0, 0, 0x03, 0x03, 0, 1, 0, 0x00, 0x07, 0x00,  1,  6,  0 } /* $A */, 
  { 0x01, 1, 1, 0x03, 0x03, 1, 1, 1, 0x00, 0x07, 0x00,  2,  7,  0 } /* $10 */, 

  { 0x01, 1, 1, 0x03, 0x03, 0, 1, 1, 0x00, 0x06, 0x00,  2, 10,  3 } /* $11 */, 
  { 0x01, 0, 0, 0x03, 0x03, 0, 1, 0, 0x00, 0x05, 0x00,  1, 12,  5 } /* $14 */, 
  { 0x01, 1, 1, 0x03, 0x03, 0, 1, 1, 0x00, 0x05, 0x00,  2, 13,  5 } /* $19 */, 
  { 0x01, 0, 0, 0x01, 0x01, 0, 1, 0, 0x00, 0x07, 0x00,  1, 18, 10 } /* $22 */, 
  { 0x01, 1, 1, 0x01, 0x01, 1, 1, 1, 0x00, 0x06, 0x00,  2, 19, 10 } /* $27 */, 
  { 0x01, 1, 1, 0x03, 0x03, 1, 1, 1, 0x00, 0x06, 0x00,  2, 23, 14 } /* $28 */, 
  { 0x07, 2, 2, 0x01, 0x01, 0, 1, 0, 0x00, 0x02, 0x00,  4, 25, 16 } /* $2E */, 
  { 0x0D, 3, 3, 0x01, 0x01, 1, 1, 0, 0x00, 0x06, 0x00,  4, 26, 18 } /* $31 */, 

  { 0x01, 0, 0, 0x01, 0x01, 0, 1, 0, 0x00, 0x02, 0x00,  1, 45, 75 } /* $34 */, 
  { 0x01, 0, 0, 0x01, 0x01, 0, 1, 0, 0x00, 0x02, 0x00,  1, 46, 75 } /* $36 */, 
  { 0x01, 0, 0, 0x01, 0x01, 0, 1, 0, 0x00, 0x02, 0x00,  1, 47, 75 } /* $37 */, 
  { 0x01, 1, 1, 0x03, 0x03, 1, 1, 1, 0x00, 0x07, 0x00,  2, 48, 75 } /* $3E */, 
  { 0x01, 1, 1, 0x03, 0x03, 0, 1, 1, 0x00, 0x06, 0x00,  2, 49, 76 } /* $85 */, 
  { 0x00, 0, 0, 0x00, 0x00, 0, 1, 0, 0x00, 0x00, 0x00,  1, 51, 78 } /* $FF */
};
...
{
  {   0, { 0x03, 0x03, 0 }, { 0x07, 0x07, 0x00 }, kDescStateNoTransition,    0, ApplDescRead_Diagnostic_DataEmissions } /* $1 */, 
  {   0, { 0x03, 0x03, 0 }, { 0x07, 0x07, 0x00 }, kDescStateNoTransition,    0, ApplDescRead_Freeze_Frame_DataEmissions } /* $2 */, 
  {   1, { 0x03, 0x03, 0 }, { 0x07, 0x07, 0x00 }, kDescStateNoTransition,    0, ApplDescRead_Emissions_DTCsEmissions } /* $3 */, 
  {   1, { 0x03, 0x03, 0 }, { 0x07, 0x07, 0x00 }, kDescStateNoTransition,    0, ApplDescClear_Emissions_DTCsEmissions } /* $4 */, 
  {   1, { 0x03, 0x03, 0 }, { 0x07, 0x07, 0x00 }, kDescStateNoTransition,    0, ApplDescRead_Current_Emissions_DTCsEmissions } /* $7 */, 
  {   0, { 0x03, 0x03, 0 }, { 0x07, 0x07, 0x00 }, kDescStateNoTransition,    0, ApplDescRead_Vehicle_InfoEmissions } /* $9 */, 
  {   1, { 0x03, 0x03, 0 }, { 0x07, 0x07, 0x00 }, kDescStateNoTransition,    0, ApplDescRead_Permanent_Emission_DTCsEmissions } /* $A */, 
  {   2, { 0x03, 0x03, 0 }, { 0x07, 0x07, 0x00 },                      0,    0, DescOemStartDefault_Session } /* $10 $1 */, 

  {   2, { 0x03, 0x03, 0 }, { 0x06, 0x06, 0x00 },                      1,    0, DescOemStartProgramming_Session } /* $10 $2 */, 
  {   2, { 0x03, 0x03, 0 }, { 0x03, 0x05, 0x00 },                      2,    0, DescOemStartExtended_Session } /* $10 $3 */, 
  {   2, { 0x03, 0x03, 0 }, { 0x07, 0x06, 0x00 },                      3,    0, ApplDescResetHard_Reset } /* $11 $1 */, 
  {   2, { 0x03, 0x03, 0 }, { 0x07, 0x06, 0x00 },                      4,    0, ApplDescResetSoft_Reset } /* $11 $3 */, 
  {   4, { 0x03, 0x03, 0 }, { 0x03, 0x05, 0x00 }, kDescStateNoTransition,    0, ApplDescClearFaultMemory } /* $14 */, 
  {   3, { 0x03, 0x03, 0 }, { 0x03, 0x05, 0x00 }, kDescStateNoTransition,    0, ApplDescReadNumberFaultMemory } /* $19 $1 */, 
  {   3, { 0x03, 0x03, 0 }, { 0x03, 0x05, 0x00 }, kDescStateNoTransition,    0, ApplDescReadAllIdentifiedFaultMemory } /* $19 $2 */, 
  {   6, { 0x01, 0x01, 0 }, { 0x03, 0x05, 0x00 }, kDescStateNoTransition,    0, ApplDescReadEnvironmentDataFaultMemory } /* $19 $4 */, 

  {   6, { 0x01, 0x01, 0 }, { 0x03, 0x05, 0x00 }, kDescStateNoTransition,    0, ApplDescRead_extendedFaultMemory } /* $19 $6 */, 
  {   2, { 0x03, 0x03, 0 }, { 0x03, 0x05, 0x00 }, kDescStateNoTransition,    0, ApplDescReadAllSupportedFaultMemory } /* $19 $A */, 
  {   0, { 0x01, 0x01, 0 }, { 0x07, 0x07, 0x00 }, kDescStateNoTransition,    1, DescReadDataByIdentifier } /* $22 */, 
  {   2, { 0x01, 0x01, 0 }, { 0x03, 0x04, 0x00 }, kDescStateNoTransition,    0, DescOemRequestRequest_Seed_Level_1 } /* $27 $1 */, 
  {   6, { 0x01, 0x01, 0 }, { 0x01, 0x04, 0x00 },                      5,    0, DescOemSendSend_Key_Level_1 } /* $27 $2 */, 
  {   2, { 0x01, 0x01, 0 }, { 0x05, 0x02, 0x00 }, kDescStateNoTransition,    0, DescOemRequestRequest_Seed_Level_2 } /* $27 $11 */, 
  {   6, { 0x01, 0x01, 0 }, { 0x01, 0x02, 0x00 },                      6,    0, DescOemSendSend_Key_Level_2 } /* $27 $12 */, 
  {   3, { 0x03, 0x03, 0 }, { 0x07, 0x06, 0x00 }, kDescStateNoTransition,    2, DescOemControlEnableRxAndEnableTx } /* $28 $0 */, 

  {   3, { 0x03, 0x03, 0 }, { 0x07, 0x06, 0x00 }, kDescStateNoTransition,    2, DescOemControlEnableRxAndDisableTx } /* $28 $1 */, 
  {  12, { 0x01, 0x01, 0 }, { 0x04, 0x02, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteFingerprint } /* $2E $F1 $5A */, 
  {   4, { 0x01, 0x01, 0 }, { 0x06, 0x06, 0x00 }, kDescStateNoTransition,    0, ApplDescStartLearn_VIN } /* $31 $1 $2 $0 */, 
  { 132, { 0x01, 0x01, 0 }, { 0x04, 0x02, 0x00 }, kDescStateNoTransition,    0, ApplDescStartCheck_Checksum } /* $31 $1 $2 $2 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x06, 0x06, 0x00 }, kDescStateNoTransition,    0, ApplDescStartCheck_Programming_Preconditions } /* $31 $1 $2 $3 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x02, 0x04, 0x00 }, kDescStateNoTransition,    0, ApplDescStartDecrease_Failed_Security_Access_Counter } /* $31 $1 $2 $4 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x06, 0x06, 0x00 }, kDescStateNoTransition,    0, ApplDescStartSOC_Learning } /* $31 $1 $F0 $4 */, 
  {   7, { 0x01, 0x01, 0 }, { 0x06, 0x06, 0x00 }, kDescStateNoTransition,    0, ApplDescStartVTBM_Reprogramming } /* $31 $1 $F0 $7 */, 

  {   4, { 0x01, 0x01, 0 }, { 0x06, 0x06, 0x00 }, kDescStateNoTransition,    0, ApplDescStartReset_Contactor_Wear } /* $31 $1 $F0 $8 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x06, 0x06, 0x00 }, kDescStateNoTransition,    0, ApplDescStartSOH_Learning_Phase_1 } /* $31 $1 $F0 $9 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x06, 0x06, 0x00 }, kDescStateNoTransition,    0, ApplDescStartSOH_Learning_Phase_2 } /* $31 $1 $F0 $A */, 
  {   4, { 0x01, 0x01, 0 }, { 0x06, 0x06, 0x00 }, kDescStateNoTransition,    0, ApplDescStartSOH_Learning_Phase_3 } /* $31 $1 $F0 $B */, 
  {  13, { 0x01, 0x01, 0 }, { 0x04, 0x02, 0x00 }, kDescStateNoTransition,    0, ApplDescStartErase_Memory } /* $31 $1 $FF $0 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x04, 0x02, 0x00 }, kDescStateNoTransition,    0, ApplDescStartCheck_Programming_Dependencies } /* $31 $1 $FF $1 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x06, 0x06, 0x00 }, kDescStateNoTransition,    0, ApplDescStopSOH_Learning_Phase_1 } /* $31 $2 $F0 $9 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x06, 0x06, 0x00 }, kDescStateNoTransition,    0, ApplDescStopSOH_Learning_Phase_2 } /* $31 $2 $F0 $A */, 

  {   4, { 0x01, 0x01, 0 }, { 0x06, 0x06, 0x00 }, kDescStateNoTransition,    0, ApplDescStopSOH_Learning_Phase_3 } /* $31 $2 $F0 $B */, 
  {   4, { 0x01, 0x01, 0 }, { 0x06, 0x06, 0x00 }, kDescStateNoTransition,    0, ApplDescResultsVTBM_Reprogramming } /* $31 $3 $F0 $7 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x06, 0x06, 0x00 }, kDescStateNoTransition,    0, ApplDescResultsSOH_Learning_Phase_1 } /* $31 $3 $F0 $9 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x06, 0x06, 0x00 }, kDescStateNoTransition,    0, ApplDescResultsSOH_Learning_Phase_2 } /* $31 $3 $F0 $A */, 
  {   4, { 0x01, 0x01, 0 }, { 0x06, 0x06, 0x00 }, kDescStateNoTransition,    0, ApplDescResultsSOH_Learning_Phase_3 } /* $31 $3 $F0 $B */, 
  {  11, { 0x01, 0x01, 0 }, { 0x04, 0x02, 0x00 }, kDescStateNoTransition,    0, ApplDescRequestDownload } /* $34 */, 
  {   0, { 0x01, 0x01, 0 }, { 0x04, 0x02, 0x00 }, kDescStateNoTransition,    0, ApplDescTransmitDownload } /* $36 */, 
  {   1, { 0x01, 0x01, 0 }, { 0x04, 0x02, 0x00 }, kDescStateNoTransition,    0, ApplDescStopDownload } /* $37 */, 

  {   2, { 0x03, 0x03, 0 }, { 0x07, 0x07, 0x00 }, kDescStateNoTransition,    0, DescOemProcessTesterPresent } /* $3E $0 */, 
  {   5, { 0x03, 0x03, 0 }, { 0x07, 0x06, 0x00 }, kDescStateNoTransition,    0, ApplDescSendTurn_DTC_Setting_On } /* $85 $1 */, 
  {   5, { 0x03, 0x03, 0 }, { 0x07, 0x06, 0x00 }, kDescStateNoTransition,    0, ApplDescSendTurn_DTC_Setting_Off } /* $85 $2 */
};
...
V_MEMROM0 static V_MEMROM1 DescMsgItem V_MEMROM2 g_descSvcInstHeadExt[kDescSvcInstHeadExtNumItems] = 
{
  0x01, 0x02, 0x03 /* $10 */, 
  0x01, 0x03 /* $11 */, 
  0x01, 0x02, 0x04, 0x06, 0x0A /* $19 */, 
  0x01, 0x02, 0x11, 0x12 /* $27 */, 
  0x00, 0x01 /* $28 */, 
  0xF1, 0x5A /* $2E */, 
  0x01, 0x02, 0x00, 0x01, 0x02, 0x02, 0x01, 0x02, 0x03, 0x01, 0x02, 0x04, 0x01, 0xF0, 0x04, 0x01, 0xF0, 0x07 /* $31 */, 
  0x01, 0xF0, 0x08, 0x01, 0xF0, 0x09, 0x01, 0xF0, 0x0A, 0x01, 0xF0, 0x0B, 0x01, 0xFF, 0x00, 0x01, 0xFF, 0x01 /* $31 */, 

  0x02, 0xF0, 0x09, 0x02, 0xF0, 0x0A, 0x02, 0xF0, 0x0B, 0x03, 0xF0, 0x07, 0x03, 0xF0, 0x09, 0x03, 0xF0, 0x0A /* $31 */, 
  0x03, 0xF0, 0x0B /* $31 */, 
  0x00 /* $3E */, 
  0x01, 0x02 /* $85 */
};
...
{
  { 0x0100, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadFault_Memory_Status }, 
  { 0x0300, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadECU_Diagnostic_State }, 
  { 0x0301, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadVehicle_Positive_Contactor_Opening_Current_Table }, 
  { 0x0302, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadCharger_Positive_Contactor_Opening_Current_Table }, 
  { 0x0303, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadCell_Temperature_Table }, 
  { 0x0306, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadCurrent_SOC }, 
  { 0x0307, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadState_of_Balance }, 
  { 0x0308, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadCurrent_State_of_Health }, 

  { 0x0309, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadCurrent_Lowest_Cell_Temperature }, 
  { 0x030A, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadCell_Number_with_Current_Lowest_Cell_Temperature }, 
  { 0x030B, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadCurrent_Highest_Cell_Temperature }, 
  { 0x030C, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadCell_Number_with_Current_Highest_Cell_Temperature }, 
  { 0x030D, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadCurrent_Lowest_Cell_Voltage }, 
  { 0x030E, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadCell_Number_with_Current_Lowest_Cell_Voltage }, 
  { 0x030F, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadCurrent_Highest_Cell_Voltage }, 
  { 0x0310, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadCell_Number_with_Current_Highest_Cell_Voltage }, 

  { 0x0311, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadHighest_Cell_Temperature_Ever }, 
  { 0x0312, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadCell_Number_with_Highest_Cell_Temperature_Ever }, 
  { 0x0313, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadLowest_Cell_Temperature_Ever }, 
  { 0x0314, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadCell_Number_with_Lowest_Cell_Temperature_Ever }, 
  { 0x0315, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadOperating_Mode_Table }, 
  { 0x0316, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadRegen_Energy_Wh_Table }, 
  { 0x0317, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadCharging_Energy_Wh_Table }, 
  { 0x0318, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadVehicle_Energy_Wh_Table }, 

  { 0x0319, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadVTBM_Active_Balancing_Table }, 
  { 0x031A, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadVTBM_Passive_Balancing_Table }, 
  { 0x031B, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadNumber_of_Cells_Being_Actively_Balanced_Table }, 
  { 0x031C, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadNumber_of_Cells_Being_Passively_Balanced_Table }, 
  { 0x031D, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadHighest_Coolant_Inlet_Temperature_Ever }, 
  { 0x031E, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadLowest_Coolant_Inlet_Temperature_Ever }, 
  { 0x031F, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadCurrent_Inlet_Coolant_Temperature }, 
  { 0x0321, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadNumber_of_Charger_Contactor_Closing_Operations }, 

  { 0x0322, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadNumber_of_Vehicle_Contactor_Closing_Operations }, 
  { 0x0323, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadDelta_Cell_Temperature_Table }, 
  { 0x0324, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadDelta_Cell_Voltage_Table }, 
  { 0x0325, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadLowest_SOC_Ever }, 
  { 0x0326, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadNumber_of_Successful_Charge_Cycles }, 
  { 0x0327, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadNumber_of_HVIL_Broken_While_Contactors_Closed }, 
  { 0x0328, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadNumber_of_HVIL_Broken_While_Contactors_Open }, 
  { 0x0329, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadVHybridBattery }, 

  { 0x032A, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadIActual }, 
  { 0x032B, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadPDischargeMaxShortTerm }, 
  { 0x032C, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadIDischargeMaxShortTerm }, 
  { 0x032D, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadIChargeMaxShortTerm }, 
  { 0x032E, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadPChargeMaxShortTerm }, 
  { 0x032F, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadNBatterySOCDesired }, 
  { 0x0330, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadPDischargeMaxMediumTerm }, 
  { 0x0331, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadIDischargeMaxMediumTerm }, 

  { 0x0332, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadIChargeMaxMediumTerm }, 
  { 0x0333, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadPChargeMaxMediumTerm }, 
  { 0x0334, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadIDischargeMaxLongTerm }, 
  { 0x0335, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadPDischargeMaxLongTerm }, 
  { 0x0336, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadIChargeMaxLongTerm }, 
  { 0x0337, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadPChargeMaxLongTerm }, 
  { 0x0338, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadVPackDCLink }, 
  { 0x0339, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadIRaw }, 

  { 0x033A, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadN_NMSleepBMS }, 
  { 0x033B, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadDIDs }, 
  { 0x033C, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadVehicle_Negative_Contactor_Opening_Current_Table }, 
  { 0x033D, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadVehicle_Pre_charge_Contactor_Opening_Current_Table }, 
  { 0x033E, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadCharger_Negative_Contactor_Opening_Current_Table }, 
  { 0x033F, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadReference_State_of_Health }, 
  { 0x0340, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadVehicle_Bus_Positive_Rail_Voltage }, 
  { 0x0341, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadVehicle_Bus_Negative_Rail_Voltage }, 

  { 0x0342, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadCharger_Bus_Positive_Rail_Voltage }, 
  { 0x0343, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadCharger_Bus_Negative_Rail_Voltage }, 
  { 0x0344, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadLast_Estimated_Balance_at_Top_of_Charge }, 
  { 0x0345, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadLast_Estimated_Balance_at_Bottom_of_Charge }, 
  { 0x0346, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadLast_Estimated_Balance_at_Top_of_Charge_Timestamp }, 
  { 0x0347, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadLast_Estimated_Balance_at_Bottom_of_Charge_Timestamp }, 
  { 0x0348, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadNumber_of_Ignition_Cycles }, 
  { 0x0349, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadSOC_Table }, 

  { 0x034A, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadVehicle_Bus_Current_Table }, 
  { 0x034B, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadCharger_Bus_Current_Table }, 
  { 0x034C, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadPrecharge_Contactor_Wear_Counter }, 
  { 0x034D, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadVehicle_Bus_Positive_Contactor_Wear_Counter }, 
  { 0x034E, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadVehicle_Bus_Negative_Contactor_Wear_Counter }, 
  { 0x034F, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadCharger_Bus_Positive_Contactor_Wear_Counter }, 
  { 0x0350, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadCharger_Bus_Negative_Contactor_Wear_Counter }, 
  { 0x0351, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadHighest_SOC_Ever }, 

  { 0x0352, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadHighest_Cell_Voltage_Ever }, 
  { 0x0353, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadCell_Number_with_Highest_Cell_Voltage_Ever }, 
  { 0x0354, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadLowest_Cell_Voltage_Ever }, 
  { 0x0355, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadCell_Number_with_Lowest_Cell_Voltage_Ever }, 
  { 0x0356, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadHighest_Outlet_Coolant_Temperature_Ever }, 
  { 0x0357, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadLowest_Outlet_Coolant_Temperature_Ever }, 
  { 0x0358, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadHighest_Coolant_Temperature_Delta_Ever }, 
  { 0x0359, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadHighest_Charge_Current_Ever }, 

  { 0x035A, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadHighest_Discharge_Current_Ever }, 
  { 0x035B, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadCurrent_Outlet_Coolant_Temperature }, 
  { 0x035C, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadCurrent_BMS_Timestamp }, 
  { 0x035D, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadCell_Storage_Temperature_Table }, 
  { 0x035E, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadHighest_Cell_Storage_Temperature_Ever }, 
  { 0x035F, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadCell_Number_with_Highest_Cell_Storage_Temperature_Ever }, 
  { 0x0360, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadLowest_Cell_Storage_Temperature_Ever }, 
  { 0x0361, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadCell_Number_with_Lowest_Cell_Storage_Temperature_Ever }, 

  { 0x0362, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadTotal_Energy_Throughput }, 
  { 0x0363, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadHighest_Operational_Cell_Voltage_Ever }, 
  { 0x0364, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadCell_Number_with_Highest_Operational_Cell_Voltage_Ever }, 
  { 0x0365, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadOperational_Lowest_Cell_Voltage_Ever }, 
  { 0x0366, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadCell_Number_with_Lowest_Operational_Cell_Voltage_Ever }, 
  { 0x0367, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadTotal_Vehicle_Energy }, 
  { 0x0368, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadTotal_Regen_Energy }, 
  { 0x0369, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadTotal_Charger_Energy }, 

  { 0x036A, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadSOCcHigh }, 
  { 0x036B, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadSOCcLow }, 
  { 0x036C, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadSOC_Reset_State }, 
  { 0x036D, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadSOC_Reset_Timer }, 
  { 0xF100, { { 0x07, 0x07, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadID_Block }, 
  { 0xF15A, { { 0x07, 0x07, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadFingerprint }, 
  { 0xF180, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadBoot_Software_ID }, 
  { 0xF181, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadApplication_Software_ID }, 

  { 0xF182, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadCalibration_Data_ID }, 
  { 0xF183, { { 0x07, 0x07, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadBoot_Software_Fingerprint }, 
  { 0xF184, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadApplication_Software_Fingerprint }, 
  { 0xF185, { { 0x07, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadCalibration_Data_Fingerprint }, 
  { 0xF18B, { { 0x07, 0x07, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadECU_Manufacturing_Date }, 
  { 0xF18C, { { 0x07, 0x07, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadECU_Serial_Number }, 
  { 0xF190, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadVIN }, 
  { 0xF191, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadHardware_ID }, 

  { 0xF193, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadSystem_Supplier_ECU_Hardware_Version_Number }, 
  { 0xFEA0, { { 0x03, 0x05, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadPack_Serial_Number }
};
...
#if defined(DESC_ENABLE_NODE_POWER_CONTROL) || (kDescNumContexts > 1)
...
/* Source address information is available only with ISO TP (no multi bus) */
#if defined (DESC_ENABLE_ACCESS_TESTER_ADDRESS_API)
# if defined (DESC_ENABLE_USDT_MULTI_BUS_SUPPORT)
#  error "Access to the tester address is not supported when the communication bus abstraction is enabled!"
# endif
...
# if 0
  /* Write debug info */
  g_descInterruptContextCtrl[DESC_CONTEXT_PARAM_VALUE].infoPoolPtr->reqDataPtr[kDescPrimBufferLen + 0] = kDescAssertBufferLenPattern0;
  g_descInterruptContextCtrl[DESC_CONTEXT_PARAM_VALUE].infoPoolPtr->reqDataPtr[kDescPrimBufferLen + 1] = kDescAssertBufferLenPattern1;
  /* TBD: Could not be written to while init phase */
# endif
}
#endif
...
# if defined (TP_ENABLE_DYNAMIC_CHANNELS)
  ...
  descTmpTxChannel = TpTxGetConnectionStatus(kDescDiagConnection);
  if(descTmpTxChannel == kTpNoChannel)
  {
    if( (g_descUsdtNetTpTxChannel = TpTxGetFreeChannel(kDescDiagConnection)) != kTpNoChannel )
    {
      TpTxLockChannel(g_descUsdtNetTpTxChannel);
#  if defined (DESC_ENABLE_BUSY_REPEAT_RESPONDER)
      /* Initialize the transmission type */
      g_descTpCtrl.txPath[g_descUsdtNetTpTxChannel].type = kDescMainTransmission;
#  endif
    }
  }
#  if defined (DESC_ENABLE_DEBUG_INTERNAL)
  ...
  { /* The TX channel is still locked but is it the same as before? */
    DescUsdtNetIsoTpAssertChannel(g_descUsdtNetTpTxChannel == descTmpTxChannel, kDescAssertWrongTpTxChannel);
  }
#  endif
  DescUsdtNetIsoTpAssertChannel(g_descUsdtNetTpTxChannel != kTpNoChannel, kDescAssertWrongTpTxChannel);
# endif
#endif
...
#endif
  g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].descHandle = kDescUsdtNetInvalidDescContext;
  g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].reqDataPtr = g_descBuffer;
  g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].resDataPtr = g_descBuffer;
  g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].resType = kDescUsdtResponseNone;
...
#endif
  {
    if (g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].descHandle == kDescUsdtNetInvalidDescContext)
    {
...
# endif
#endif
        g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].busInfo.busType   = kDescUsdtNetBusTypeIsoTp;
#if (TP_USE_EXTENDED_ADDRESSING           == kTpOn)      || \
    defined (TP_ENABLE_NORMAL_FIXED_ADDRESSING)  || \
    defined (TP_ENABLE_MIXED_29_ADDRESSING)
        g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].busInfo.addressingInfo.isoTp.SourceAddress = TpRxGetSourceAddress(TP_CHANNEL_RX_PARAM_ONLY);
    /* g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].busInfo.addressingInfo.isoTp.TargetAddress = TpRxGetReceivedTargetAddress (TP_CHANNEL_RX_PARAM_VALUE); */
#endif

#if ( kCanNumberOfChannels > 1 ) /* more than one canChannel ? */
# if defined (DESC_USDTNET_ENABLE_MULTI_TP)
        g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].busInfo.addressingInfo.isoTp.CanChannel = TpRxGetCanChannel(TP_CHANNEL_RX_PARAM_ONLY);
# else
        g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].busInfo.addressingInfo.isoTp.CanChannel = TpRxGetCanChannel();
# endif
#endif
#if defined (DESC_USDTNET_ENABLE_MULTI_TP)
        g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].busHandle         = TP_CHANNEL_RX_PARAM_VALUE;
#endif
#if defined (TP_ENABLE_EXTENDED_ADDRESSING)
# if defined (TP_DISABLE_CHECKTA_COMPATIBILITY)
...
#endif
        {
          g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].reqType         = kDescUsdtNetReqTypePhysical;
        }
#if defined (TP_ENABLE_EXTENDED_ADDRESSING)
# if defined (TP_DISABLE_CHECKTA_COMPATIBILITY)
        else
        {
          g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].reqType         = kDescUsdtNetReqTypeFunctional;
        }
# endif
#endif
        g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].dataLength        = dataLength;
        g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].descHandle        = 0; /* Write used context */

        /* Check if Desc itself is free */
        result = DescUsdtNetStartReception(&g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool]);
...
#endif
          returnValue = g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].reqDataPtr;
        }
        else
        {
          g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].descHandle = kDescUsdtNetInvalidDescContext; /* Write used context */
        }
      }
    }
#if defined (DESC_ENABLE_BUSY_REPEAT_RESPONDER)
...
#endif
#if defined (DESC_USDTNET_ENABLE_MULTI_TP)
    DescUsdtNetIsoTpAssertChannel(g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].busHandle == TP_CHANNEL_RX_PARAM_VALUE, kDescNetAssertWrongIsoTpRxChannel);
#endif
    /*-----------------------------*/
...
#else
  g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].busInfo.addressingInfo.isoTp.Connection = TpRxGetConnectionNumber(TP_CHANNEL_RX_PARAM_ONLY);
#endif
#if defined (TP_ENABLE_DYNAMIC_CHANNELS)
# if defined (TP_ENABLE_NORMAL_ADDRESSING)       || \
     defined (TP_ENABLE_MIXED_11_ADDRESSING)
    g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].busInfo.addressingInfo.isoTp.ReceiveID = TpRxGetChannelID(TP_CHANNEL_RX_PARAM_ONLY);
#  if defined (TP_FUNC_ENABLE_RECEPTION)
    if (g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].reqType == kDescUsdtNetReqTypeFunctional)
    {
      TpFuncSetResponse(g_descUsdtNetTpTxChannel);
    }
    else
#  endif
    {
      TpTxSetResponse(g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].busHandle, g_descUsdtNetTpTxChannel);
    }
# endif
#endif
#if (TP_USE_MULTIPLE_ECU_NR == kTpOn)
    g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].busInfo.addressingInfo.isoTp.TargetAddress = TpRxGetEcuNumber(TP_CHANNEL_RX_PARAM_ONLY);
#else
# if (TP_USE_EXTENDED_ADDRESSING == kTpOn) || \
     defined (TP_ENABLE_NORMAL_FIXED_ADDRESSING) || \
     defined (TP_ENABLE_MIXED_29_ADDRESSING)
    g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].busInfo.addressingInfo.isoTp.TargetAddress = kDescEcuNumber;
# endif
#endif
#if (TP_USE_EXTENDED_ADDRESSING == kTpOn)
# if (TP_USE_MULTIPLE_BASEADDRESS == kTpOn)
    g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].busInfo.addressingInfo.isoTp.BaseAddress = TpRxGetBaseAddress(TP_CHANNEL_RX_PARAM_ONLY);
# endif
#endif
    /* Reception has finished */
    DescUsdtNetFinishReception(&g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool], kDescUsdtNetworkOk);
    /* Reset the channel */
...
#if defined (DESC_ENABLE_BUSY_REPEAT_RESPONDER)
  switch (g_descTpCtrl.rxPath[tpRxChannel].type)
  {
    case kDescMainReception:
#endif
#if defined (DESC_USDTNET_ENABLE_MULTI_TP)
      ...
      DescUsdtNetFinishReception(&g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool], kDescUsdtNetworkAbort);
#if defined (DESC_ENABLE_BUSY_REPEAT_RESPONDER)
      break;
    case kDescAddReception:
      /* reset the additional cahnnel status */
      g_descAddChannelCtrl.channel[g_descTpCtrl.rxPath[tpRxChannel].info].status = kDescContextIdle;
      break;
    default:
      /* Unknown type */
      DescUsdtNetIsoTpAssertUserAlways(kDescAssertUnknownTpTransmissionType);
...
#if defined (DESC_USDTNET_ENABLE_MULTI_TP)
# if defined (TP_ENABLE_DYNAMIC_CHANNELS)
  tpTxChannel = g_descUsdtNetTpTxChannel;
...
# endif
  ...
  g_busInfoPoolTxRef[TP_CHANNEL_TX_PARAM_VALUE] = infoPool;
    ...
    defined (TP_ENABLE_NORMAL_FIXED_ADDRESSING) || \
    defined (TP_ENABLE_MIXED_29_ADDRESSING)
  TpTxSetTargetAddress (TP_CHANNEL_TX_PARAM_FIRST infoPool->busInfo.addressingInfo.isoTp.TargetAddress);
#endif
#if ( kTpNumberOfCanChannels > 1 ) /* more than one canChannel ? */
# if defined (TP_ENABLE_DYNAMIC_CHANNELS)
  TpTxSetCanChannel(TP_CHANNEL_TX_PARAM_FIRST infoPool->busInfo.addressingInfo.isoTp.CanChannel);
# endif
#endif
#if (TP_USE_MULTIPLE_ECU_NR == kTpOn)
...
# if defined (DESC_ENABLE_MULTI_TP_MULTI_CAN_WORKAROUND)
  result = TpTransmit(TP_CHANNEL_TX_PARAM_FIRST infoPool->resDataPtr, infoPool->dataLength);
# else
...
# endif
      ...
      {
        DescMsgCopyFarRamToRam((vuint8*)infoStruct->pDestination, infoStruct->pSource, infoStruct->Length);
        returnValue = kTpSuccess;
      }
      return returnValue;
#else
    ...
    while(addIter != 0)
    {
      ...
      if(g_descAddChannelCtrl.channel[addIter].status == kDescContextActiveProcess)
      {
        ...
        if (tpTxChannel != kTpNoChannel)
        {
          ...
          if (TpTransmit(tpTxChannel, g_descAddChannelCtrl.channel[addIter].buffers.res.resBuffer, 3) == kTpSuccess)
          {
...
*                    
*******************************************************************************/
TP_MEMORY_MODEL_DATA vuint8* DescGetFuncBuffer(vuint16 dataLength)
{
  DescMsg returnValue = V_NULL;
...
# endif
  {
# if defined (DESC_ENABLE_PARALLEL_OBD)
    DESC_CONTEXT_PARAM_DEF_LOCAL /* For OBD */
    /* OBD predispatching for request routing */
    DESC_CONTEXT_PARAM_ONLY = ((TpFuncGetCanBuffer()[0] > 0x00)&&(TpFuncGetCanBuffer()[0] < 0x0A))?kDescObdContext:kDescPrimContext;
# endif
    if (g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].descHandle == kDescUsdtNetInvalidDescContext)
    {
      t_descUsdtNetResult result;
      ...
      g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].busInfo.busType   = kDescUsdtNetBusTypeIsoTp;
# if ( kCanNumberOfChannels > 1 ) /* more than one canChannel ? */
      g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].busInfo.addressingInfo.isoTp.CanChannel = TpFuncGetCanChannel();
# endif
# if defined (TP_ENABLE_EXTENDED_ADDRESSING)      || \
     defined (TP_ENABLE_NORMAL_FIXED_ADDRESSING)  || \
     defined (TP_ENABLE_MIXED_29_ADDRESSING)
      g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].busInfo.addressingInfo.isoTp.SourceAddress = TpFuncGetSourceAddress();
    /* g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].busInfo.addressingInfo.isoTp.TargetAddress = TpRxGetReceivedTargetAddress (TP_CHANNEL_RX_PARAM_VALUE); */
# endif
# if defined (DESC_USDTNET_ENABLE_MULTI_TP)
      g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].busHandle         = 0xfe;
# endif
      g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].reqType           = kDescUsdtNetReqTypeFunctional;
      g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].resType           = kDescUsdtResponseNone;
      g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].reqDataPtr        = g_descBuffer;
      ...
      g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].dataLength        = dataLength;
# if defined (DESC_ENABLE_PARALLEL_OBD)
      g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].descHandle        = DESC_CONTEXT_PARAM_ONLY; /* Write used context */
# else
      g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].descHandle        = 0; /* Write used context */
# endif
...
# if defined (DESC_USDTNET_ENABLE_MULTI_TP)
  if (g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].busHandle == 0xfe)
# endif
  {
    /*-----------------------------*/
    /*Transport protocol management*/
...
#  if defined (TP_ENABLE_NORMAL_ADDRESSING)       || \
      defined (TP_ENABLE_MIXED_11_ADDRESSING)
    g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].busInfo.addressingInfo.isoTp.ReceiveID = TpFuncGetReceiveCanID();
    TpFuncSetResponse(g_descUsdtNetTpTxChannel);
#  endif
# endif
# if (TP_USE_MULTIPLE_ECU_NR == kTpOn)
    g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].busInfo.addressingInfo.isoTp.TargetAddress = TpFuncGetTargetAddress();
# else
#  if (TP_USE_EXTENDED_ADDRESSING == kTpOn) || \
      defined (TP_ENABLE_NORMAL_FIXED_ADDRESSING) || \
      defined(TP_FUNC_ENABLE_EXTENDED_ADDRESSING) || \
...
# if (TP_USE_EXTENDED_ADDRESSING == kTpOn)
#  if (TP_USE_MULTIPLE_BASEADDRESS == kTpOn)
    g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool].busInfo.addressingInfo.isoTp.BaseAddress = TpFuncGetBaseAddress();
#  endif
# endif
    /* Reception has finished */
    DescUsdtNetFinishReception(&g_descUsdtNetInfoPoolIsoTp[kDescUsdtNetPrimInfoPool], kDescUsdtNetworkOk);
...
static DescBool DescSendSpontaneousResponse(DescMsg resData, DescMsgLen resLen, t_descUsdtNetBus busInfo)
{
  if(g_descUsdtNetSpontanResInfoPool.resType == kDescUsdtResponseNone)
  {
    ...
    if(g_descInterruptContextCtrl[kDescPrimContext].activity == kDescContextIdle)
    {
      ...
      g_descUsdtNetSpontanResInfoPool.busInfo = busInfo;
...
#if defined (DESC_ENABLE_NODE_POWER_CONTROL) && defined (DESC_ENABLE_DEFAULT_SESSION_SLEEP_PREVENTION)
    DescSetNpmOnCanChannelActive(infoPool->busInfo.addressingInfo.isoTp.CanChannel, g_descCanChannelMapQueue);
#endif
#if defined (DESC_ENABLE_ACCESS_TESTER_ADDRESS_API)
    /* Store the ISO TP Source Address */
    g_descTesterAddress[DESC_CONTEXT_PARAM_WRAPPER_INDEX(infoPool->descHandle)] = infoPool->busInfo.addressingInfo.isoTp.SourceAddress;
#endif
    /* Notify the application */
#if defined (DESC_ENABLE_DESCICN_SUPPORT)
    /* Check if this instance is a internal request */
...
DescStateGroup DESC_API_CALL_TYPE DescGetSessionStateOfSessionId(DescMsgItem sessionId)
{
  ...
  {
    return g_descStateGroupTransition[g_descSvcInst[iter + kDescSvcInstOffsetSDS].setStateIndex][1].stateSession;
  }

  /* Would mean illegal state was found */
  DescAssertCommonAlways(kDescAssertInvalidStateParameterValue);
  /*lint --e(527) */
  return kDescStateValueInvalid;
}
#endif
...
DescMsgItem DESC_API_CALL_TYPE DescGetSessionIdOfSessionState(DescStateGroup sessionState)
{
  ...
  while (iter < (kDescSvcInstOffsetSDS + kDescNumStateSession))
  {
    ...
    {
      if(g_descStateGroupTransition[g_descSvcInst[iter].setStateIndex][1].stateSession == sessionState)
      {
  ...
  /* Check if not found */
  DescAssertCommon((iter < (kDescSvcInstOffsetSDS + kDescNumStateSession)), kDescAssertInvalidStateParameterValue);
...
static void DescDispatcher(DESC_CONTEXT_FORMAL_PARAM_DEF_ONLY)
{
  ...
  if(g_descCurReqSvc[DESC_CONTEXT_PARAM_VALUE] < kDescInvalidSvcHandle)
  {
    ...
    DescAssertInternal((g_descCurReqSvc[DESC_CONTEXT_PARAM_VALUE] < kDescSvcHeadNumItems),kDescAssertSvcTableIndexOutOfRange);
...
#if defined(DESC_ENABLE_SUB_SVC_USAGE)
          vuint8_least svcInstFailedBytePosMask;
#endif
...
#endif
{
  ...
  if((g_descInterruptContextCtrl[DESC_CONTEXT_PARAM_VALUE].activity & kDescContextActiveProcess) != 0)
  {
    ...
    DescAssertCommon(((g_descInterruptContextCtrl[DESC_CONTEXT_PARAM_VALUE].infoPoolPtr->reqDataPtr[kDescPrimBufferLen + 0] == kDescAssertBufferLenPattern0)&&
                      (g_descInterruptContextCtrl[DESC_CONTEXT_PARAM_VALUE].infoPoolPtr->reqDataPtr[kDescPrimBufferLen + 1] == kDescAssertBufferLenPattern1)),kDescAssertDiagnosticBufferOverflow);
#endif
#if defined (DESC_ENABLE_PROCESSING_DONE_REDIRECTOR)
      ...
      else
      {
...
#endif
        {
          ...
          * (header + data) This macro is an optimization for adding a value: (X+=Y)*/
          ...
          g_descRingBufferCtrl[DESC_CONTEXT_PARAM_VALUE].protocolDataLen = (vbittype)resHeadLen;
#endif
        }
#if defined (DESC_ENABLE_POS_RES_ON_SET_SPRMIB)
        /* Do not consider the bit information - send always positive response */
...
/*  ********************************************************************************
 * Function name:DescOemStartDefault_Session
 * Description:Processes the session change request, parametrizing the common processing function.
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext:
...
/*  ********************************************************************************
 * Function name:DescOemStartProgramming_Session
 * Description:Processes the session change request, parametrizing the common processing function.
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext:
...
/*  ********************************************************************************
 * Function name:DescOemStartExtended_Session
 * Description:Processes the session change request, parametrizing the common processing function.
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext:
...
/*  ********************************************************************************
 * Function name:DescOemRequestRequest_Seed_Level_1
...
static void DESC_API_CALLBACK_TYPE DescOemRequestRequest_Seed_Level_1(DescMsgContext* pMsgContext)
{
  DescOemSecuritySeed(pMsgContext, kDescStateSecurityAccessUnlocked_Level_One);
}


/*  ********************************************************************************
 * Function name:DescOemSendSend_Key_Level_1
...
static void DESC_API_CALLBACK_TYPE DescOemSendSend_Key_Level_1(DescMsgContext* pMsgContext)
{
  DescOemSecurityKey(pMsgContext, kDescStateSecurityAccessUnlocked_Level_One);
}


/*  ********************************************************************************
 * Function name:DescOemRequestRequest_Seed_Level_2
 * Description:Manages the security get seed function.
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext:
...
static void DESC_API_CALLBACK_TYPE DescOemRequestRequest_Seed_Level_2(DescMsgContext* pMsgContext)
{
  DescOemSecuritySeed(pMsgContext, kDescStateSecurityAccessUnlocked_Level_Two);
}


/*  ********************************************************************************
 * Function name:DescOemSendSend_Key_Level_2
 * Description:Manages the security send key function.
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext:
...
static void DESC_API_CALLBACK_TYPE DescOemSendSend_Key_Level_2(DescMsgContext* pMsgContext)
{
  DescOemSecurityKey(pMsgContext, kDescStateSecurityAccessUnlocked_Level_Two);
}
...
*
* CALLED BY:         DescOemPostEcuPassiveMode_Disable, DescOemInit
* PRECONDITIONS:     
*
* DESCRIPTION:       
*
...
static void DescOemCommonCommCtrlProcess(vuint8 reqInfo, DescMsgContext *pMsgContext)
{
...
#endif
  {
    ...
    if(((DescMsgItem)(pMsgContext->reqData[0] & 0x0F) > kDescCommControlMsgTypeAll)||
       ((DescMsgItem)(pMsgContext->reqData[0] & 0x0F) == 0))
    {
      errorCode = kDescNrcRequestOutOfRange;
    }

    g_descCommControlInfo.msgTypes = (DescMsgItem)(pMsgContext->reqData[0] & 0x0F);
    /* Extract the subnet number */
    g_descCommControlInfo.subNetNumber = (vuint8)((pMsgContext->reqData[0] & 0xF0) >> 4);
#else
    g_descCommControlInfo.msgTypes = (vbittype)(kDescCommControlMsgAppl);
    /* Subnet number is always all*/
    g_descCommControlInfo.subNetNumber = kDescCommControlSubNetNumAll;
#endif
...
#if defined (DESC_ENABLE_RX_COMM_CONTROL)
    /* Set the TX communication state */
    g_descCommControlInfo.rxPathState = (vbittype)(reqInfo >> 2);
#endif
#if defined(DESC_ENABLE_MULTI_CHANNEL_SUPPORT)
    g_descCommControlInfo.reqCommChannel = g_descInterruptContextCtrl[DESC_CONTEXT_PARAM_WRAPPER_INDEX(pMsgContext->iContext)].infoPoolPtr->busInfo.addressingInfo.isoTp.CanChannel;
#endif
...
static void DescOemPrepareSessionControl(DescMsgContext *pMsgContext, DescStateGroup targetSession)
{
...
#endif
  {
    ...
    DescSetNpmOnCanChannelActive(pMsgContext->busInfo.addressingInfo.isoTp.CanChannel, g_descCanChannelMapQueue);
#endif
  }
...
void DescSetAttemptCounterValue(DESC_CONTEXT_FORMAL_PARAM_DEF_FIRST vuint8 value)
{
  ...
  if(g_descSecureNrOfAttempts >= kDescMaxNumberOfAttempts)
  {
    ...
    g_descSecureNrOfAttempts = (vuint8)(kDescMaxNumberOfAttempts - 1);
...
#if defined(DESC_ENABLE_LEVEL_SPECIFIC_SEED_PROTECTION)
      &&(g_descSecurityAccessContext.securityLevel == requestedSecurityLevel)
#endif
      )
    {
...
# if (kDescSecureTimer != 0)
      ...
      g_descSecureNrOfAttempts++;
      if (g_descSecureNrOfAttempts >= kDescMaxNumberOfAttempts)
      {
        /* Give him one try only - protects from increment overflow */
        g_descSecureNrOfAttempts = (vuint8)(kDescMaxNumberOfAttempts - 1);

        g_descNegResCode[DESC_CONTEXT_PARAM_WRAPPER_INDEX(pMsgContext->iContext)] = kDescNrcExceedNumOfAttempts;
        /* Activate brute-force inhibition  */
        g_descSecureTimer = DescGetTicksOfMs(kDescSecureTimer);
        /* Reset the sequence */
        g_descIsKeyAwaited = kDescFalse;
...
void DescSecurityAccessKeyChecked(DESC_CONTEXT_FORMAL_PARAM_DEF_ONLY)
{
  ...
  if(g_descSecurityAccessContext.status != kDescSaStatusOk)
  {
    ...
    if (g_descSecureNrOfAttempts >= kDescMaxNumberOfAttempts)
    {
      ...
      g_descNegResCode[DESC_CONTEXT_PARAM_VALUE] = kDescNrcExceedNumOfAttempts;
      /* Activate brute-force inhibition  */
      g_descSecureTimer = DescGetTicksOfMs(kDescSecureTimer);
    }
    else
...
#else
        DescPmAnalysePid(DESC_CONTEXT_PARAM_FIRST &g_descPIDInfo[pidHandle].tinyInfo);
#endif
        if(g_descNegResCode[DESC_CONTEXT_PARAM_VALUE] == kDescNrcNone)
        {
